...
export const salesContent = {
  ...
  bonuses: {
    ...
    items: [
      {
        tag: 'BÔNUS #1',
        title: 'ROTINAS VOCAIS PARA CORAL DE IGREJA',
        subtitle: '20 sequências de preparação vocal',
        desc: 'Tenha sequências organizadas para preparar as vozes antes de ensaios, cultos e apresentações.',
        img: '/assets/rotinas-opt.webp',
      },
      {
        tag: 'BÔNUS #2',
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        bonusHighlights: [
          { tag: '#1', title: 'Rotinas Vocais para Coral de Igreja' },
  ...
  upsellModal: {
    ...
    benefits: [
      { icon: '🎁', label: 'Bônus #1: Rotinas Vocais para Coral' },
